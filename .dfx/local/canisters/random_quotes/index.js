...
import { idlFactory } from './random_quotes.did.js';
export { idlFactory } from './random_quotes.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RANDOM_QUOTES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./random_quotes.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the random_quotes canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./random_quotes.did.js")._SERVICE>}
 */
export const random_quotes = createActor(canisterId);
